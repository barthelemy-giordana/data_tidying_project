...
saveRDS(df1,file = "data_tidying_project/data/raw_data/df_department.rds")

saveRDS(df2,file = "data_tidying_project/data/raw_data/df_retail.rds")
```
...
df_department <- df1 %>% 
  ...
  mutate(value = `Value (in millions)` * 1000000) %>%
